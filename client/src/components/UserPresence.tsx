      ...
      <div className="flex -space-x-2">
        {visible.map((u) => (
          <div key={u.id} className="relative group" style={{ zIndex: 10 }}>
            <div
              className="w-8 h-8 rounded-full border-2 border-white flex items-center justify-center text-xs font-medium text-white select-none cursor-default transition-transform group-hover:scale-110"
